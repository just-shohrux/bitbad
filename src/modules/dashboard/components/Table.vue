<template>
  <div class="table__box">
    <slot />
    <h2 class="table__title">Balans tarixi</h2>
    ...
    <div class="table-responsive">
      <table class="table">
        <thead>
          <tr>
            <th>SANA</th>
            <th class="text-center">HISOB RAQAM</th>
            <th class="text-center" @click="filterBySum">
              <i
                class="bx"
                :class="{ 'bx-sort-up': asc, 'bx-sort-down': !asc }"
              ></i>
              SUMMA
            </th>
        ...
        <tbody>
          <tr v-if="transactions.length == 0" class="text-center">
            <td colspan="4">O'tkazmalar mavjud emas</td>
          </tr>
          <tr v-for="(transaction, i) in transactions" :key="i">
            ...
            <td class="text-center">
              <span
                :class="{
                  hold__badge: transaction.status == 'hold',
                  blue__badge: transaction.status == 'o\'tkazildi',
                  pink__badge: transaction.status == 'o\'tkazilmadi',
                }"
        ...
        <tfoot>
          <tr>
            <td>Sana</td>
            <td class="text-center">Hisob raqam</td>
  ...
  methods: {
    ...
    filterBySum() {
      ...
      this.transactionsList = slice(
        ...
        0,
        this.numbers[this.selectedId]
      );
      this.current = 1;
    },
  },
  mounted() {
    this.pagination(this.numbers[this.selectedId], this.transactions.length);
  },
};
</script>
